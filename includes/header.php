    ...
    <section>
        ...
        <div id="container">
            ...
            <div id="shopName"><a href="index.php"> <b>SHOP</b>LANE </a></div>
                ...
                <div id="collection">
                    <div id="clothingSection"><a id="clothin" href="products.php#clothing"> CLOTHING </a></div>
                    <div id="accessoriesSection"><a id="accessorie" href="products.php#accessories"> ACCESSORIES </a></div>
                </div>
                <!-- SEARCH SECTION -->
                <div id="search">
